...
export default function CheckoutCreate({ authUser }) {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        billing_address:
            authUser?.billing_address || authUser?.shipping_address || "",
        billing_city: authUser?.billing_city || authUser?.shipping_city || "",
        billing_region:
            authUser?.billing_region || authUser?.shipping_region || "",
        billing_postal_code:
            authUser?.billing_postal_code ||
            authUser?.shipping_postal_code ||
            "",
                ...
                <StoreLayout>
                    <section className="rounded-2xl border border-amber-200 bg-white p-8 text-center shadow-sm">
                        ...
                        <p className="mt-2 text-stone-700">
                            Abans de pagar, afegeix algun llibre.
                        </p>
                        <Link
    ...
    return (
        <>
            ...
            <StoreLayout>
                <h1 className="mb-5 text-3xl font-bold text-amber-950">
                    Finalitzar compra
                </h1>
                ...
                >
                    <div className="space-y-6">
                        ...
                        <section className="rounded-xl border border-amber-200 bg-white p-5 shadow-sm">
                            ...
                            <div className="mt-4 grid gap-4 md:grid-cols-2">
                                ...
                                <InputField
                                    ...
                                    onChange={(v) =>
                                        setData("shipping_region", v)
                                    }
                                    error={errors.shipping_region}
                                />
                                <InputField
                                    label="Codi postal"
                                    value={data.shipping_postal_code}
                                    onChange={(v) =>
                                        setData("shipping_postal_code", v)
                                    }
                        ...
                        <section className="rounded-xl border border-amber-200 bg-white p-5 shadow-sm">
                            ...
                            <label className="mt-3 inline-flex items-center gap-2 text-sm text-stone-700">
                                ...
                                />
                                Mateixa adreça que enviament
                            </label>

                            {!data.billing_same_as_shipping && (
                                <div className="mt-4 grid gap-4 md:grid-cols-2">
                                    <InputField
                                        label="Nom facturacio"
                                        value={data.billing_full_name}
                                        onChange={(v) =>
                                            setData("billing_full_name", v)
                                        }
                                        error={errors.billing_full_name}
                                    />
                                    <InputField
                                        label="Adreça facturacio"
                                        value={data.billing_address}
                                        onChange={(v) =>
                                            setData("billing_address", v)
                                        }
                                        error={errors.billing_address}
                                    />
                                    <InputField
                                        label="Ciutat facturacio"
                                        value={data.billing_city}
                                        onChange={(v) =>
                                            setData("billing_city", v)
                                        }
                                        error={errors.billing_city}
                                    />
                                    <InputField
                                        label="Provincia facturacio"
                                        value={data.billing_region}
                                        onChange={(v) =>
                                            setData("billing_region", v)
                                        }
                        ...
                        <section className="rounded-xl border border-amber-200 bg-white p-5 shadow-sm">
                            ...
                            <div className="mt-4 grid gap-4 md:grid-cols-3">
                                ...
                                />
                                <InputField
                                    label="Caducitat (MM/YY)"
                                    value={data.card_expiry}
                                    onChange={(v) => setData("card_expiry", v)}
                                    error={errors.card_expiry}
                                />
                                <InputField
                                    label="CVV"
                                    value={data.card_cvv}
                                    onChange={(v) => setData("card_cvv", v)}
                    ...
                    <aside className="h-fit rounded-xl border border-amber-200 bg-white p-5 shadow-sm">
                        ...
                        <div className="mt-4 border-t border-amber-100 pt-4 text-sm text-stone-700">
                            ...
                            <p className="mt-3 flex justify-between text-lg font-bold text-amber-900">
                                <span>Total</span>
